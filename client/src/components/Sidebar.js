...
const Sidebar = () => {
    return (
        <header className='drag relative min-h-screen md:flex'>
            ...
            {/* sidebar */}
            <div className='sidebar bg-white dark:bg-gray-600 dark:text-white text-black-100 w-64 pt-8 px-4 absolute inset-y-0 left-0 transform -translate-x-full md:relative md:translate-x-0 transition duration-200 ease-in-out'>
